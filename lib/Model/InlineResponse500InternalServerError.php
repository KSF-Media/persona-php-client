...
/**
 * InlineResponse500InternalServerError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class InlineResponse500InternalServerError implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_500_internal_server_error';
    ...
    const DESCRIPTION_INTERNAL_SERVER_ERROR = 'Internal server error';
    ...
    {
        return [
            self::DESCRIPTION_INTERNAL_SERVER_ERROR,
        ];
    }
