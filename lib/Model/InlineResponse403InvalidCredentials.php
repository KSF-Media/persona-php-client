...
/**
 * InlineResponse403InvalidCredentials Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class InlineResponse403InvalidCredentials implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_403_invalid_credentials';
    ...
    const DESCRIPTION_WRONG_USERNAME_OR_PASSWORD = 'Wrong username or password';
    ...
    {
        return [
            self::DESCRIPTION_WRONG_USERNAME_OR_PASSWORD,
        ];
    }
