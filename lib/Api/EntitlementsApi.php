...
class EntitlementsApi
{
    ...
    /**
     * Operation entitlementsFreePassGet
     *
     * Verify given free pass hash
     *
     * @param  string $auth_user auth_user (optional)
     * @param  string $authorization authorization (optional)
     * @param  string $free_pass_hash free_pass_hash (optional)
     *
     * @throws \PersonaClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return bool
     */
    public function entitlementsFreePassGet($auth_user = null, $authorization = null, $free_pass_hash = null)
    {
        list($response) = $this->entitlementsFreePassGetWithHttpInfo($auth_user, $authorization, $free_pass_hash);
        return $response;
    }

    /**
     * Operation entitlementsFreePassGetWithHttpInfo
     *
     * Verify given free pass hash
     *
     * @param  string $auth_user (optional)
     * @param  string $authorization (optional)
     * @param  string $free_pass_hash (optional)
     *
     * @throws \PersonaClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of bool, HTTP status code, HTTP response headers (array of strings)
     */
    public function entitlementsFreePassGetWithHttpInfo($auth_user = null, $authorization = null, $free_pass_hash = null)
    {
        $request = $this->entitlementsFreePassGetRequest($auth_user, $authorization, $free_pass_hash);
    ...
    /**
     * Operation entitlementsFreePassGetAsync
     *
     * Verify given free pass hash
     *
     * @param  string $auth_user (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function entitlementsFreePassGetAsync($auth_user = null, $authorization = null, $free_pass_hash = null)
    {
        return $this->entitlementsFreePassGetAsyncWithHttpInfo($auth_user, $authorization, $free_pass_hash)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation entitlementsFreePassGetAsyncWithHttpInfo
     *
     * Verify given free pass hash
     *
     * @param  string $auth_user (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function entitlementsFreePassGetAsyncWithHttpInfo($auth_user = null, $authorization = null, $free_pass_hash = null)
    {
        $returnType = 'bool';
        $request = $this->entitlementsFreePassGetRequest($auth_user, $authorization, $free_pass_hash);
    ...
    /**
     * Create request for operation 'entitlementsFreePassGet'
     *
     * @param  string $auth_user (optional)
     * @param  string $authorization (optional)
     * @param  string $free_pass_hash (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function entitlementsFreePassGetRequest($auth_user = null, $authorization = null, $free_pass_hash = null)
    {

        $resourcePath = '/entitlements/free-pass';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($free_pass_hash !== null) {
            $queryParams['freePassHash'] = ObjectSerializer::toQueryValue($free_pass_hash);
        }
        // header params
        if ($auth_user !== null) {
            $headerParams['AuthUser'] = ObjectSerializer::toHeaderValue($auth_user);
    ...
    /**
     * Operation entitlementsGlobalGet
     *
     ...
     * @return \PersonaClient\Model\PersistedEntitlementAccess[]
     */
    public function entitlementsGlobalGet($auth_user = null, $authorization = null)
    {
        list($response) = $this->entitlementsGlobalGetWithHttpInfo($auth_user, $authorization);
        return $response;
    }

    /**
     * Operation entitlementsGlobalGetWithHttpInfo
     *
     * Lists all past and future global entitlements
     *
     * @param  string $auth_user (optional)
     ...
     * @return array of \PersonaClient\Model\PersistedEntitlementAccess[], HTTP status code, HTTP response headers (array of strings)
     */
    public function entitlementsGlobalGetWithHttpInfo($auth_user = null, $authorization = null)
    {
        $request = $this->entitlementsGlobalGetRequest($auth_user, $authorization);
    ...
    /**
     * Operation entitlementsGlobalGetAsync
     *
     * Lists all past and future global entitlements
     *
     * @param  string $auth_user (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function entitlementsGlobalGetAsync($auth_user = null, $authorization = null)
    {
        return $this->entitlementsGlobalGetAsyncWithHttpInfo($auth_user, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation entitlementsGlobalGetAsyncWithHttpInfo
     *
     * Lists all past and future global entitlements
     *
     * @param  string $auth_user (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function entitlementsGlobalGetAsyncWithHttpInfo($auth_user = null, $authorization = null)
    {
        $returnType = '\PersonaClient\Model\PersistedEntitlementAccess[]';
        $request = $this->entitlementsGlobalGetRequest($auth_user, $authorization);
    ...
    /**
     * Create request for operation 'entitlementsGlobalGet'
     *
     * @param  string $auth_user (optional)
     * @param  string $authorization (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function entitlementsGlobalGetRequest($auth_user = null, $authorization = null)
    {

        $resourcePath = '/entitlements/global';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
